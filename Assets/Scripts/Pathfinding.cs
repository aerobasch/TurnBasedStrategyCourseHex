...
public class Pathfinding : MonoBehaviour
{
    ...
    public List<GridPosition> FindPath(GridPosition startGridPosition, GridPosition endGridPostion,out int pathLength)
    {
        ...
        PathNode endNode = gridSystem.GetGridObject(endGridPostion);
        ...
        startNode.SetHCost(CalculateHeuristicDistance(startGridPosition,endGridPostion));
        ...
        while (openList.Count > 0) 
        {
            ...
            foreach(PathNode neighbourNode in GetNeighbourList(currentNode))
            {
                ...
                if (tentativeGcost < neighbourNode.GetGCost())
                {
                    ...
                    neighbourNode.SetHCost(CalculateHeuristicDistance(neighbourNode.GetGridPosition(), endGridPostion));
